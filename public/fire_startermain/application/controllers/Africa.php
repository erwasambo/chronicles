...
class Africa extends Public_Controller {
    ...
    public function index(){
        ...
        // load views
//        $data['content'] = $this->load->view('places/africa', $content_data, TRUE);
        $this->load->view('places/africa', $data);
    }
    ...
    public function details(){
        ...
        // load views
        $data['content'] = $this->load->view('places/details', $content_data, TRUE);
