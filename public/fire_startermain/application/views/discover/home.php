...
<!-- extra div for emulating position:fixed of the menu -->
                <div class="st-content-inner">
                    <nav class="navbar-subnav navbar-static-top" role="navigation">
                        <div class="container">
                    ...
                    <div class="container">
                        <div class="cover profile">
                            <div class="wrapper">
                                <div class="image">
                                    <img src="<?php echo base_url('themes/default/images/profile-cover.jpg'); ?>" alt="people" />
                                </div>
                                <ul class="friends">
                                    <li>
                                        <a href="#">
                                            <img src="<?php echo base_url('themes/default/images/people/110/guy-6.jpg'); ?>" alt="people" class="img-responsive">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="<?php echo base_url('themes/default/images/people/110/woman-3.jpg'); ?>" alt="people" class="img-responsive">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="<?php echo base_url('themes/default/images/people/110/guy-2.jpg'); ?>" alt="people" class="img-responsive">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="<?php echo base_url('themes/default/images/people/110/guy-9.jpg'); ?>" alt="people" class="img-responsive">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="<?php echo base_url('themes/default/images/people/110/woman-9.jpg'); ?>" alt="people" class="img-responsive">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="<?php echo base_url('themes/default/images/people/110/guy-4.jpg'); ?>" alt="people" class="img-responsive">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="<?php echo base_url('themes/default/images/people/110/guy-1.jpg'); ?>" alt="people" class="img-responsive">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="<?php echo base_url('themes/default/images/people/110/woman-4.jpg'); ?>" alt="people" class="img-responsive">
                                        </a>
                                    </li>
                            ...
                            <div class="cover-info">
                                <div class="avatar">
                                    <img src="<?php echo base_url('themes/default/images/people/110/guy-5.jpg'); ?>" alt="people" />
                                </div>
                            ...
                            <div class="col-xs-12 col-md-6 col-lg-4 item">
                                <div class="timeline-block">
                                    <div class="panel panel-default relative">
                                        <img src="<?php echo base_url('themes/default/images/place2-full.jpg'); ?>" alt="place" class="img-responsive">
                                        ...
                                        <div class="panel-body">
                                            <img src="<?php echo base_url('themes/default/images/people/50/guy-2.jpg'); ?>" alt="people" class="img-circle" />
                                            <img src="<?php echo base_url('themes/default/images/people/50/woman-2.jpg'); ?>" alt="people" class="img-circle" />
                                            <img src="<?php echo base_url('themes/default/images/people/50/guy-3.jpg'); ?>" alt="people" class="img-circle" />
                                            <img src="<?php echo base_url('themes/default/images/people/50/woman-3.jpg'); ?>" alt="people" class="img-circle" />
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="">
                                                        <img src="<?php echo base_url('themes/default/images/people/50/woman-6.jpg'); ?>" class="media-object">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="timeline-added-images">
                                                <img  src="<?php echo base_url('themes/default/images/social/100/1.jpg'); ?>" width="80" alt="photo" />
                                                <img  src="<?php echo base_url('themes/default/images/social/100/2.jpg'); ?>" width="80" alt="photo" />
                                                <img  src="<?php echo base_url('themes/default/images/social/100/3.jpg'); ?>" width="80" alt="photo" />
                                            </div>
                                        </div>
                                        ...
                                        <ul class="comments">
                                            <li class="media">
                                                <div class="media-left">
                                                    <a href="">
                                                        <img src="<?php echo base_url('themes/default/images/people/50/guy-5.jpg'); ?>" class="media-object">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <li class="media">
                                                <div class="media-left">
                                                    <a href="">
                                                        <img src="<?php echo base_url('themes/default/images/people/50/woman-5.jpg'); ?>" class="media-object">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <div class="pull-right dropdown" data-show-hover="li">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="">
                                                        <img src="<?php echo base_url('themes/default/images/people/50/guy-6.jpg'); ?>" class="media-object">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <a href="#" class="pull-right text-muted"><i class="icon-reply-all-fill fa fa-2x "></i></a>
                                        ...
                                        <img src="<?php echo base_url('themes/default/images/place1-full.jpg'); ?>" class="img-responsive">
                                        <ul class="comments">
                                            <li clas="media">
                                                <div class="media-left">
                                                    <a href="">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="">
                                                        <img src="<?php echo base_url('themes/default/images/people/50/woman-3.jpg'); ?>" class="media-object">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <a href="#" class="pull-right text-muted"><i class="icon-reply-all-fill fa fa-2x "></i></a>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="">
                                                        <img src="<?php echo base_url('themes/default/images/people/50/woman-4.jpg'); ?>" class="media-object">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <a href="#" class="pull-right text-muted"><i class="icon-reply-all-fill fa fa-2x "></i></a>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="profile-block">
                                            <div class="cover overlay cover-image-full">
                                                <img src="<?php echo base_url('themes/default/images/place1-full.jpg'); ?>" alt="cover">
                                                <div class="overlay overlay-full overlay-bg-black">
                                                    ...
                                                    <div class="v-bottom">
                                                        <a href="#">
                                                            <img src="<?php echo base_url('themes/default/images/people/110/guy-6.jpg'); ?>" alt="people" class="img-circle avatar" />
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="">
                                                        <img src="<?php echo base_url('themes/default/images/people/50/guy-2.jpg'); ?>" class="media-object">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <a href="#" class="pull-right text-muted"><i class="icon-reply-all-fill fa fa-2x "></i></a>
                                        ...
                                        <div class="panel-body">
                                            <div class="boxed">
                                                ...
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#">
                                                        <img src="<?php echo base_url('themes/default/images/food1.jpg'); ?>" alt="" width="80" class="media-object">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
...
<img src="<?php echo base_url('themes/default/images/people/50/woman-5.jpg'); ?>" class="media-object">
    ...
    <link href="<?php echo base_url('themes/default/css/vendor.min.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('themes/default/css/theme-core.min.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('themes/default/css/module-essentials.min.css'); ?>" rel="stylesheet" />
    <link href="<?php echo base_url('themes/default/css/module-layout.min.css'); ?>" rel="stylesheet" />
    <link href="<?php echo base_url('themes/default/css/module-sidebar.min.css'); ?>" rel="stylesheet" />
    <link href="<?php echo base_url('themes/default/css/module-sidebar-skins.min.css'); ?>" rel="stylesheet" />
    <link href="<?php echo base_url('themes/default/css/module-navbar.min.css'); ?>" rel="stylesheet" />
    <link href="<?php echo base_url('themes/default/css/module-timeline.min.css'); ?>" rel="stylesheet" />
    <link href="<?php echo base_url('themes/default/css/module-cover.min.css'); ?>" rel="stylesheet" />
    <link href="<?php echo base_url('themes/default/css/module-chat.min.css'); ?>" rel="stylesheet" />
    <link href="<?php echo base_url('themes/default/css/module-maps.min.css'); ?>" rel="stylesheet" />




   <!-- Separate Vendor Script Bundles -->
    <script src="<?php echo base_url('themes/default/js/vendor-core.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/default/js/vendor-tables.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/default/js/vendor-forms.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/default/js/vendor-maps.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/default/js/module-essentials.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/default/js/module-layout.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/default/js/module-sidebar.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/default/js/module-timeline.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/default/js/module-chat.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/default/js/module-maps.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/default/js/theme-core.min.js'); ?>"></script>
